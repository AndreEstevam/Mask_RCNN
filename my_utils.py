...
def extract_masks_from_cluster(clustered_mask, bool_array=False, ch_first=False):
    ...
    Args:
        ...
        ch_first: set this to True if you want shape (nÃ‚Â° of instances, height, width)
    Return:
        masks: numpy array of shape (height, width, nÃ‚Â° of instances);
